...
<fieldset>
  ...
  <input type="text" class="input-field" name="produk" value="" /></label>

  <label for="spesifikasi"><span>spesifikasi <span class="required">*</span></span>
  	<input type="text" class="input-field" name="spesifikasi" value="" /></label>
