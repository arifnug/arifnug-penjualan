				...
				<div class="wthree_banner_bottom_left_grid_sub">
				 ...
				 <div class="wthree_banner_bottom_left_grid_sub1">
						...
						<div class="col-md-4 wthree_banner_bottom_left ">
							...
							<img src="images/<?=$barang["image"]; ?>" alt=" " class="img-responsive" width="200" height="200">
							<div class="center"><p>	<?=$barang["produk"]; ?></p></div><br>
							price : $<?=$barang["harga"];?><br>
							<?=$barang["spesifikasi"]; ?>
							<br>	
							<div class="edit1">
								<a href="edit.php?id=<?=$barang["id"]; ?>"><p>EDIT	</p> </a>
							</div>
							 <div class="edit2">
							 	<a href="hapus.php?id=<?=$barang['id'] ?>" onclick="return confirm('tenan???')"><p>DELETE	</p></a>
		...
		<div class="container">
			<div class="col-md-3 w3_footer_grid">
				...
				<ul class="w3_footer_grid_list">
					...
					<li><a href="index.php">Short Codes</a></li>
				</ul>
			</div>
			<div class="col-md-3 w3_footer_grid">
				<h3>policy info</h3>
